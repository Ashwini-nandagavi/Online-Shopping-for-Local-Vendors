...
<nav class="navbar">
  <a href="index.php"><i class="fas fa-home"style="color:purple; font-size:40px;"></i>Home</a>
  <a href="aboutus.php"><i class="fas fa-address-card"style="color:purple; font-size:40px;"></i>About Us</a>
  <a   class="active1" href="contactus.php"><i class="fas fa-phone-volume"style="color:purple; font-size:40px;"></i>Contact Us</a>
  <div class="dropdown">
...
<h2 style="text-align:center;">Contact Us</h2>
  ...
  <div class="contactuscolumn">
    <div class="contactuscard">
      <h3>EmailID:</h3>
      <p>EmailID:susmitacm79@gmail.com</p>
      <p>EmailID:aknandagavi@gmail.com</p>
    </div>
  </div>
  </div>
  <div class="maprow">
    <div class="contactusformcolumn">
      ...
      <iframe src="https://www.google.com/maps/d/embed?mid=1D92Wqnh-ynjkksRre0Nh9PnEFlpanjI&ehbc=2E312F" width="900" height="800"></iframe></div>
	      <div class="contactusformcolumn">
      <form method="POST" action="#"  name="myForm1" onsubmit="return formValidate1()">
        <label>Full Name</label>
        <input type="text" id="fname" name="fullname"  placeholder="Your full name..">
        <label>Mobile Number</label>
        <input type="text" id="umob" name="mobno" placeholder="Your Mobile Number..">
        <label>Email ID</label>
        <input type="text" id="email" name="emailid" placeholder="Your Email ID..">
        <label>Query</label>
        <textarea id="query" name="query" placeholder="Write Query here .." style="height:100px" width="100px" ></textarea>
...
$conn=mysqli_connect('localhost','root','','onlineshopy');
if(!$conn)
{
  die("could not connect mysql database".mysqli_error($conn));
...
$insertquery="insert into query values('$fullname','$mobno','$emailid','$query')";
$result=mysqli_query($conn,$insertquery) or die('error in insert query');
if($result==1)
{
  echo '<script>';
  echo 'swal("Thank You","Your Query is reach to us","success")';
  echo '</script>';
}
else
{
  echo '<script>';
  echo 'swal("Sorry","Your Account is  not created please check details!","error")';
  echo '</script>';
